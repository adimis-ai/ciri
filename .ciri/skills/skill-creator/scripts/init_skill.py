...
Examples:
    init_skill.py my-new-skill                  # Creates in .ciri/skills/my-new-skill
    init_skill.py my-api-helper --path skills   # Creates in skills/my-api-helper
"""
...
def main():
    ...
    try:
        ...
        print(f"❌ Error creating parent directory {path}: {e}")
        sys.exit(1)
