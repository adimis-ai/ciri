...
def test_skill_input_validation():
    ...
    with pytest.raises(ValueError, match="lowercase alphanumeric"):
        SkillInput(
            name="invalid_skill_name", description="Description", content="Content"
        )

    # Invalid name with uppercase
    with pytest.raises(ValueError, match="lowercase alphanumeric"):
        SkillInput(
            name="Invalid-Skill-Name", description="Description", content="Content"
        )

    # Empty name
    with pytest.raises(ValueError):
        SkillInput(name="", description="Description", content="Content")
