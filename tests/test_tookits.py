...
async def test_toolkit_discovery_and_injection(project_root):
    ...
    with patch("subprocess.run") as mock_run, \
        ...
        mock_client.get_tools = AsyncMock(return_value=[MockTool("echo"), MockTool("add")])
        ...
        assert str(project_root / ".ciri" / "toolkits" / "test_toolkit") in middleware._toolkit_versions
